...
import (
	...
	appconfig "grouter/templates/nats-grpc-service/internal/config"
	internal "grouter/templates/nats-grpc-service/internal/grpc"

	googlegrpc "google.golang.org/grpc"

	// Import service packages to register factories
	_ "grouter/templates/nats-grpc-service/internal/pkg/api"
)
...
func (a *App) ID() string { return "nats-grpc-service" }
