...
**Client Output:**
```
🚀 Hybrid Service Client - Testing REST + NATS
================================================

📋 Test 1: REST Health Checks
  ✅ Liveness probe: OK
  ✅ Readiness probe: {"id":"hybrid-api","name":"Hybrid API","status":"running"}
